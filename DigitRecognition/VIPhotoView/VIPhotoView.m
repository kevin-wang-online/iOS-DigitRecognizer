...
- (instancetype)initWithFrame:(CGRect)frame andImage:(UIImage *)image scaleMode:(int)mode
{
    ...
    if (self) {
        ...
        {
            self.minimumZoomScale = (float)imageSize.width / self.imageView.contentSize.width;
        }
